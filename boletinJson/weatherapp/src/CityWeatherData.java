...
public class CityWeatherData {
    public CityWeatherData(JsonObject weatherData) {
    ...
    public void initializaData(JsonObject weatherData) {
        ...
        date = Instant.ofEpochSecond(weatherData.getJsonNumber("dt").longValue()).atZone(ZoneId.of("GMT+1"))
    ...
    public String toString() {
        return String.format(
                ...
                name, latitude, longitude, temperature, humidity, percentageProbabilityOfClouds, windSpeed, forecast,
                date);
    }
